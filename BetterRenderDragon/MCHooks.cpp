...
void initMCHooks() {
	...
	TrySigHook(readFile,
		...
		//1.21.23
		"48 89 5C 24 08 55 56 57 41 56 41 57 48 8D AC 24 50 FF FF FF 48 81 EC B0 01 00 00 48 8B 05 A6 F8 74 05 48 33 C4 48 89 85 A0 00 00 00 49 8B F8 48 8B F2 48 89 55 F8 45 33 FF 0F 57 C9 F3 0F 7F 4D "
	);
	...
	if (TrySigHookNoWarning(mce_framebuilder_BgfxFrameBuilder_endFrame, "48 89 5C 24 ? 55 56 57 41 54 41 55 41 56 41 57 48 8D AC 24 ? ? ? ? B8 ? ? ? ? E8 ? ? ? ? 48 2B E0 0F 29 B4 24 ? ? ? ? 0F 29 BC 24 ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 85 ? ? ? ? 4C 8B FA 48 89 55 ? 4C 8B F1")) {
		...
		//1.21.23
		"48 89 5C 24 18 55 56 57 41 54 41 55 41 56 41 57 48 8D AC 24 B0 F0 FF FF B8 50 10 00 00 E8 0E B7 21 01 48 2B E0 0F 29 B4 24 40 10 00 00 0F 29 BC 24 30 10 00 00 48 8B 05 0C 72 0A 02 48 33 C4 48"
	)) {
